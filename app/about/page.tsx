        ...
        <div className="grid grid-cols-1 md:grid-cols-[30%,70%] gap-16">
          ...
          <div className="flex justify-start items-start mt-24">
            ...
            <div className="text-left">
              <div className="text-[160px] font-extrabold leading-none">S</div>
          ...
          <div className="mt-8">
            ...
            <p className="text-[20px] leading-relaxed text-gray-700 font-normal">
              ...
              full-stack experience that loves to design and build products that
              solve challenging world-scale problems with careful user research,
              design, planning, and strong engineering principles. I have a
              sharp eye for pixel-perfect detail.
            </p>
